#Made by following a Pygame tutorial from Clear Code on youtube.com
#2d sprite game where player jumps to avoid collision with animals.
#If player contacts enemies, the game ends and score is displayed.
...
fly_frame_index = 0
snail_surf = fly_frames[fly_frame_index]
...
while True:
    ...
    if game_active:
        ...
        score_message = test_font.render(f'Your score: {score}',False,(111,169,196))
